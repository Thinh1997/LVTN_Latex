%Trang bìa
\chapmoi{TỔNG QUAN VỀ CÔNG TRÌNH TÍNH TOÁN}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\linewidth]{embedded_system.jpg}
...
\begin{figure}[H]
\begin{subfigure}{0.5\textwidth}
	\includegraphics[width=0.9\linewidth]{esp8266.jpg} 
	\caption{Board ESP8266}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
	\includegraphics[width=0.9\linewidth]{stm32f407_20discovery.jpg}
